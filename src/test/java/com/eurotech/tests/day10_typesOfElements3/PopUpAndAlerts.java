...
public class PopUpAndAlerts {
    ...
    public void test1() throws InterruptedException {
        driver.get("http://primefaces.org/showcase/ui/overlay/confirmDialog.xhtml?jfwid=cd46f");
        ...
        String actualMessage = driver.findElement(By.xpath(
                "//p[text()='You have accepted']")).getText();
    ...
    public void JSAlerts() throws InterruptedException {
        ...
        Thread.sleep(2000);
        alert.sendKeys("EuroTech Batch_6");
        Thread.sleep(2000);
        alert.accept();

        // homework
        // verify all result above JS Alerts
